                ...
                <article class="table-container">
                    <table id="tabla">
                        ...
                        <?php
                                ...
                                include 'consultarProducto.php';
                                while($fila=mysqli_fetch_assoc($result)){
                            ?>
                            <tr>
                                <td><?php echo $fila['reg_date'] ?></td>
                                ...
                                <td>
                                <?php echo "<a href='update.php?id=".$fila['n_producto']."'>Editar</a>"; ?>
                                -
                                <?php echo "<a href='delete.php?id=".$fila['n_producto']."'>Eliminar</a>"; ?>
                                </td>
                            </tr>
                            <?php
                                }
